    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editModalLabel"> {{ __('file.Edit Task') }}</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form method="POST" action="{{ route('lead.task.update', ['lead' => $lead->id, 'leadTask'=> 7]) }}" id="updateForm" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="points" id="pointsEdit" class="form-control selectpicker" data-live-search="true" data-live-search-style="contains" title="{{__('Selecting',['key'=>trans('file.Status')])}}...">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="priority" id="priorityEdit" class="form-control" title="{{__('Selecting',['key'=>trans('file.Priority')])}}...">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="labels" id="labelsEdit" class="form-control selectpicker" title="{{__('Selecting',['key'=>trans('file.Labels')])}}...">
