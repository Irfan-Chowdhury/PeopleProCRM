...
<div class="container-fluid">
    <div class="card">
        <div class="card-header"><h3>{{__('file.Item Category')}}</h3></div>
...
<script type="text/javascript">
    let dataTableURL = "{{ route('itemCategory.datatable') }}";
    let storeURL = "{{ route('itemCategory.store') }}";
    var editURL = "{{ url('sales/item-categories/edit')}}/";
    var updateURL = "{{ url('sales/item-categories/update')}}/" ;
    let destroyURL = "{{ url('sales/item-categories/destroy')}}/";
    let bulkDeleteURL = "{{ route('itemCategory.bulk_delete')}}";
</script>
