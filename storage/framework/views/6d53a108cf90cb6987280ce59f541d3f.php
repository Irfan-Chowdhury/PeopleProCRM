...
<?php echo $__env->make('crm::lead_section.contracts.create-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('crm::lead_section.contracts.edit-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script type="text/javascript">
    let dataTableURL = "<?php echo e(route('lead.contracts.datatable', ['lead' => $lead->id])); ?>";
    let storeURL = "<?php echo e(route('lead.contracts.store', ['lead' => $lead->id])); ?>";
    var editURL = "<?php echo e(url('/leads/details')); ?>/" + "<?php echo e($lead->id); ?>/contracts/edit/" ;
    var updateURL = "<?php echo e(url('/leads/details')); ?>/" + "<?php echo e($lead->id); ?>/contracts/update/" ;
    let destroyURL = "<?php echo e(url('/leads/details')); ?>/" + "<?php echo e($lead->id); ?>/contracts/destroy/";
    let bulkDeleteURL = '<?php echo e(route('lead.contracts.bulk_delete', ['lead' => $lead->id])); ?>';
</script>
        ...
        $(document).on('click', '.edit', function() {
            ...
            $.get({
                ...
                success: function (response) {
                    ...
                    $("#modelId").val(response.leadContract.id);
                    $("#editModal input[name='title']").val(response.leadContract.title);
...
<?php echo $__env->make('crm::lead_section.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/peoplepro/peoplepro-hrm-crm/Modules/CRM/resources/views/lead_section/contracts/index.blade.php ENDPATH**/ ?>