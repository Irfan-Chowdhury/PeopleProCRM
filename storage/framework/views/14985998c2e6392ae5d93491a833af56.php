	...
	<div class="col-md-6 offset-md-3">
		<div class="wrapper">
            ...
            <div class="content text-center">
                ...
                <a href="<?php echo e(route('crm-install-step-2')); ?>" class="btn btn-primary">Accept & Continue</a>
                <hr class="mt-lg-5">
...
<?php /**PATH /var/www/html/peoplepro/peoplepro-hrm-crm/resources/views/addons/crm/step_1.blade.php ENDPATH**/ ?>