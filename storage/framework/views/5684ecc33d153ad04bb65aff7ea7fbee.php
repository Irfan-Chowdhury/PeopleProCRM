    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editModalLabel"> <?php echo e(__('file.Show Subscription')); ?></h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select disabled name="repeat_type" id="repeatTypeEdit" class="form-control" title="<?php echo e(__('Selecting',['key'=>trans('file.Repeat Type')])); ?>...">
...
<?php /**PATH /var/www/html/peoplepro/peoplepro-hrm-crm/Modules/CRM/resources/views/client/subscription/show-modal.blade.php ENDPATH**/ ?>