        ...
        <div class="card">
            <div class="card-body">
                <ul class="nav nav-tabs d-flex justify-content-between" id="myTab" role="tablist">
                    ...
                    <li class="nav-item">
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('lead.files.index') ? 'active' : ''); ?>"  href="<?php echo e(route('lead.files.index', $leadId)); ?>" role="tab"><?php echo e(trans('file.Files')); ?></a>
                        </li>
                    </li>
                </ul>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/peoplepro/peoplepro-hrm-crm/Modules/CRM/resources/views/lead_section/layout.blade.php ENDPATH**/ ?>