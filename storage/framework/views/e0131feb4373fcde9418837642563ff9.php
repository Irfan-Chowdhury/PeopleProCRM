        ...
        <div class="modal-content">
            ...
            <form method="POST" id="submitForm" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="row">
                        <input type="hidden" name="contract_id" value="<?php echo e($contract->id); ?>" class="form-control">
...
<?php /**PATH /var/www/html/peoplepro/peoplepro-hrm-crm/Modules/CRM/resources/views/sale_section/contracts/contract_item/create-modal.blade.php ENDPATH**/ ?>