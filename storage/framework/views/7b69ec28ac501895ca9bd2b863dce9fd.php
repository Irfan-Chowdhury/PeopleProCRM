...
<head>
    ...
    <!-- Google fonts - Roboto -->
    <link rel="icon" type="image/png" href="<?php echo e(asset('docs/crm/assets/images/logo.png')); ?>"/>
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Nunito:400,700">
    <link rel="stylesheet" href="<?php echo e(asset('docs/attendance_device_addon/assets/css/documenter_style.css')); ?>" media="all">
    <link rel="stylesheet" href="<?php echo e(asset('docs/attendance_device_addon/assets/css/jquery.mCustomScrollbar.css')); ?>" media="all">

    <script src="<?php echo e(asset('docs/attendance_device_addon/assets/js/jquery.js')); ?>"></script>
    <script src="<?php echo e(asset('docs/attendance_device_addon/assets/js/jquery.mCustomScrollbar.js')); ?>"></script>
    <script src="<?php echo e(asset('docs/attendance_device_addon/assets/js/typeAhead.js')); ?>"></script>
    <script src="<?php echo e(asset('docs/attendance_device_addon/assets/js/script.js')); ?>"></script>
</head>

<body>
<div id="documenter_sidebar">
    <img src="<?php echo e(asset('docs/crm/assets/images/logo.png')); ?>" style="border: none;margin: 0 10px -10px;width: 200px">
...
<div id="documenter_content">
    ...
    <section id="install">
        ...
        <ul>
            ...
            <img alt="" src="<?php echo e(asset('docs/crm/assets/images/step1.png')); ?>">
        </ul>
        ...
        <ul>
            ...
            <img alt="" src="<?php echo e(asset('docs/crm/assets/images/step2.png')); ?>">
        </ul>
        ...
        <ul>
            ...
            <img alt="" src="<?php echo e(asset('docs/crm/assets/images/step3.png')); ?>">
        </ul>
        ...
        <ul>
            ...
            <img alt="" src="<?php echo e(asset('docs/crm/assets/images/step4.png')); ?>">
            <img alt="" src="<?php echo e(asset('docs/crm/assets/images/step5.png')); ?>">
        </ul>
        ...
        <ul>
            ...
            <img alt="" src="<?php echo e(asset('docs/crm/assets/images/step6.png')); ?>">
        </ul>
    ...
    <section id="leads">
        ...
        <img alt="" src="<?php echo e(asset('docs/crm/assets/images/pic-1.png')); ?>">
    </section>
    ...
    <section id="leadsContact">
        ...
        <img alt="" src="<?php echo e(asset('docs/crm/assets/images/pic-2.png')); ?>">
    </section>
    ...
    <section id="leadsInfo">
        ...
        <img alt="" src="<?php echo e(asset('docs/crm/assets/images/pic-3.png')); ?>">
    </section>
    ...
    <section id="leadsTask">
        ...
        <img alt="" src="<?php echo e(asset('docs/crm/assets/images/pic-4.png')); ?>">
    </section>
    ...
    <section id="leadsEstimate">
        ...
        <img alt="" src="<?php echo e(asset('docs/crm/assets/images/pic-5.png')); ?>">
    </section>
    ...
    <section id="leadsProposal">
        ...
        <img alt="" src="<?php echo e(asset('docs/crm/assets/images/pic-6.png')); ?>">
    </section>
    ...
    <section id="leadsContracts">
        ...
        <img alt="" src="<?php echo e(asset('docs/crm/assets/images/pic-7.png')); ?>">
    </section>
    ...
    <section id="leadsNotes">
        ...
        <img alt="" src="<?php echo e(asset('docs/crm/assets/images/pic-8.png')); ?>">
    </section>
    ...
    <section id="subscription">
        ...
        <img alt="" src="<?php echo e(asset('docs/crm/assets/images/pic-9.png')); ?>">
    </section>
    ...
    <section id="itemCategory">
        ...
        <img alt="" src="<?php echo e(asset('docs/crm/assets/images/pic-10.png')); ?>">
    </section>
    ...
    <section id="item">
        ...
        <img alt="" src="<?php echo e(asset('docs/crm/assets/images/pic-11.png')); ?>">
    </section>
    ...
    <section id="invoices">
        ...
        <p><b># Datatable</b></p>
        <img alt="" src="<?php echo e(asset('docs/crm/assets/images/pic-12.png')); ?>">
        <p><b># Create Invoice</b></p>
        <img alt="" src="<?php echo e(asset('docs/crm/assets/images/pic-13.png')); ?>">
        <p><b># View Details Invoice</b></p>
        <img alt="" src="<?php echo e(asset('docs/crm/assets/images/pic-14.png')); ?>">
        <p><b># Edit Invoice</b></p>
        <img alt="" src="<?php echo e(asset('docs/crm/assets/images/pic-15.png')); ?>">
    </section>
    ...
    <section id="store">
        ...
        <p><b># Items</b></p>
        <img alt="" src="<?php echo e(asset('docs/crm/assets/images/pic-16.png')); ?>">
        <p><b># Add to Cart</b></p>
        <img alt="" src="<?php echo e(asset('docs/crm/assets/images/pic-17.png')); ?>">
        <p><b># Checkout</b></p>
        <img alt="" src="<?php echo e(asset('docs/crm/assets/images/pic-18.png')); ?>">
    ...
    <section id="orderList">
        ...
        <p><b># Datatable</b></p>
        <img alt="" src="<?php echo e(asset('docs/crm/assets/images/pic-19.png')); ?>">
        <p><b># Order Details</b></p>
        <img alt="" src="<?php echo e(asset('docs/crm/assets/images/pic-20.png')); ?>">
    </section>
    ...
    <section id="payment">
        ...
        <p><b># Datatable</b></p>
        <img alt="" src="<?php echo e(asset('docs/crm/assets/images/pic-21.png')); ?>">
        <p><b># Add Payment</b></p>
        <img alt="" src="<?php echo e(asset('docs/crm/assets/images/pic-22.png')); ?>">
    </section>
    ...
    <section id="contracts">
        ...
        <img alt="" src="<?php echo e(asset('docs/crm/assets/images/pic-23.png')); ?>">
        <p>
        ...
        <img alt="" src="<?php echo e(asset('docs/crm/assets/images/pic-24.png')); ?>">
    </section>
    ...
    <section id="prospectsProposals">
        ...
        <img alt="" src="<?php echo e(asset('docs/crm/assets/images/pic-25.png')); ?>">
        <p>
        ...
        <img alt="" src="<?php echo e(asset('docs/crm/assets/images/pic-26.png')); ?>">
    </section>
    ...
    <section id="prospectsEstimate">
        ...
        <img alt="" src="<?php echo e(asset('docs/crm/assets/images/pic-27.png')); ?>">
        <p>
        ...
        <img alt="" src="<?php echo e(asset('docs/crm/assets/images/pic-28.png')); ?>">
    </section>
    ...
    <section id="prospectsEstimateRequest">
        ...
        <img alt="" src="<?php echo e(asset('docs/crm/assets/images/pic-29.png')); ?>">
    </section>
...
<?php /**PATH /var/www/html/peoplepro/peoplepro-hrm-crm/resources/views/documentation/crm/index.blade.php ENDPATH**/ ?>