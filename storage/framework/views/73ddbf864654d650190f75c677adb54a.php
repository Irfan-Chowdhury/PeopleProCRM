        ...
        <div class="modal-content">
            ...
            <form method="POST" id="submitForm" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="row">
                        <input type="hidden" name="proposal_id" value="<?php echo e($proposal->id); ?>" class="form-control">
...
<?php /**PATH /var/www/html/peoplepro/peoplepro-hrm-crm/Modules/CRM/resources/views/prospects/proposal_item/create-modal.blade.php ENDPATH**/ ?>