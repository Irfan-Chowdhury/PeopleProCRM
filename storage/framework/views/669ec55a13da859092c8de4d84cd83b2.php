    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editModalLabel"> <?php echo e(__('file.Edit Subscription')); ?></h5>
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select name="tax_id"
                                    ...
                                    <?php $__currentLoopData = $taxes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $taxe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($taxe->id); ?>"><?php echo e($taxe->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="repeat_type" id="repeatTypeEdit" class="form-control" title="<?php echo e(__('Selecting',['key'=>trans('file.Repeat Type')])); ?>...">
...
<?php /**PATH /var/www/html/peoplepro/peopleprocrm/Modules/CRM/resources/views/subscription_section/subscription/edit-modal.blade.php ENDPATH**/ ?>