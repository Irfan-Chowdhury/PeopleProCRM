...
<head>
    <meta charset="utf-8">
    <title>
        <?php echo e($general_settings->site_title ?? null); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('docs/assets/css/documenter_style.css')); ?>" media="all">
    <link rel="stylesheet" href="<?php echo e(asset('docs/assets/css/jquery.mCustomScrollbar.css')); ?>" media="all">

    <script src="<?php echo e(asset('docs/assets/js/jquery.js')); ?>"></script>
    <script src="<?php echo e(asset('docs/assets/js/jquery.mCustomScrollbar.js')); ?>"></script>
    <script src="<?php echo e(asset('docs/assets/js/smooth-scroll.min.js')); ?>"></script>
    <script src="<?php echo e(asset('docs/assets/js/typeAhead.js')); ?>"></script>
    <script src="<?php echo e(asset('docs/assets/js/script.js')); ?>"></script>
</head>

<body>
<div id="documenter_sidebar">
    <?php if($general_settings->site_logo): ?>
        <img src="<?php echo e(asset('/images/logo/'.$general_settings->site_logo)); ?>" style="border: none;margin: 0 0 0 0; " >
        &nbsp; &nbsp;
    <?php endif; ?>
...
<div id="documenter_content">
    ...
    <section id="install">
        ...
        <ul>
            ...
            <img alt="" src="<?php echo e(asset('docs/assets/images/step1.png')); ?>">
        </ul>
        ...
        <ul>
            ...
            <img alt="" src="<?php echo e(asset('docs/assets/images/step2.png')); ?>">
        </ul>
        ...
        <ul>
            ...
            <img alt="" src="<?php echo e(asset('docs/assets/images/step3.png')); ?>">
            <img alt="" src="<?php echo e(asset('docs/assets/images/step3_1.png')); ?>">
        </ul>
        ...
        <ul>
            ...
            <img alt="" src="<?php echo e(asset('docs/assets/images/step4.png')); ?>">
        </ul>
    ...
    <section id="common_error">
        ...
        <img alt="" src="<?php echo e(asset('docs/assets/images/env.png')); ?>">
        <img alt="" src="<?php echo e(asset('docs/assets/images/app_debug_true.png')); ?>">
    </section>
    ...
    <section id="software_update">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/update1.png')); ?>">
        </p>
        <p>Select your source and target database and click compare now.</p>
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/update2.png')); ?>">
        </p>
        <p>After comparing successfully two database click ok.</p>
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/update3.png')); ?>">
        </p>
        <p>Then select the checkbox and click Deployment Wizard.</p>
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/update4.png')); ?>">
        </p>
        <p>Uncheck the Recompare after deployment checkbox and click next.</p>
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/update5.png')); ?>">
        </p>
        <p>Click Deploy now.</p>
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/update6.png')); ?>">
        </p>
        <p>Click Ok.</p>
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/update7.png')); ?>">
        </p>
    ...
    <section id="log_in">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/login.png')); ?>">
        </p>
        <p>
    ...
    <section id="admin_dashboard">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/dashboard1.png')); ?>">
        </p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/payslip_last_six.png')); ?>">
        </p>
        <p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/employee_department.png')); ?>">
        </p>
        <p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/employee_designation.png')); ?>">
        </p>
        <p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/expense_deposit.png')); ?>">
        </p>
        <p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/project_status.png')); ?>">
        </p>
        ...
        <p>
            ...
            <img alt="" src="<?php echo e(asset('docs/assets/images/announcement_ticket_project.png')); ?>">
        </p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/calendar.png')); ?>">
        </p>
    ...
    <section id="empty_database">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/empty_database1.png')); ?>">
        </p>
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/empty_database2.png')); ?>">
        </p>
    </section>
    ...
    <section id="datatable_options">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/datatable1.png')); ?>">
        </p>
        <ol>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/datatable2.png')); ?>">
        </p>
        <ol>
    ...
    <section id="location">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/location1.png')); ?>">
        </p>
    </section>
    ...
    <section id="company">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/company1.png')); ?>">
        </p>
    </section>
    ...
    <section id="department">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/department1.png')); ?>">
        </p>
    </section>
    ...
    <section id="designation">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/designation1.png')); ?>">
        </p>
    </section>
    ...
    <section id="office_shift">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/office_shift.png')); ?>">
        </p>
        <p>
            <strong>Add Office Shift</strong><br>
            <img alt="" src="<?php echo e(asset('docs/assets/images/office_shift_add.png')); ?>">
        </p>
    </section>
    ...
    <section id="account_list">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/account_list.png')); ?>">
        </p>
        <p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/add_account.png')); ?>">
        </p>
    </section>
    ...
    <section id="roles_access">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/roles_access.png')); ?>">
        </p>
        <p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/add_role.png')); ?>">
        </p>
        <p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/permission.png')); ?>">
        </p>
        <p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/assign_role1.png')); ?>">
        </p>
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/assign_role2.png')); ?>">
        </p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/assign_role.png')); ?>">
        </p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/multi_assign.png')); ?>">
        </p>
    ...
    <section id="general_setting">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/general_setting.png')); ?>">
        </p>
    </section>
    ...
    <section id="mail_server">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/mail1.png')); ?>">
        </p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/cron_job1.jpg')); ?>">
        </p>
        <p>On your hosting c-panel go to the advance section and click on the cron jobs.
        </p>

        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/cron_job2.jpg')); ?>">
        </p>
        <p>
    ...
    <section id="language_setting">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/language_setting.png')); ?>">
        </p>
        <ul>
            <li><strong>Add (2)::</strong>You can add a new language<br>
                ...
                <p>
                    <img alt="" src="<?php echo e(asset('docs/assets/images/language_add.png')); ?>">
                </p>
            </li>
            <li><strong>Language Selector (3)::</strong>You can select the language that you want to change/update
                from the dropdown<br>
                <p>
                    <img alt="" src="<?php echo e(asset('docs/assets/images/language_select.png')); ?>">
                </p>
            </li>
    ...
    <section id="variable_type">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/variable_type.png')); ?>">
        </p>
        <ul>
            <li><strong>Leave Type :</strong>You can add/update new leave type<br>
                ...
                <p>
                    <img alt="" src="<?php echo e(asset('docs/assets/images/leave_type.png')); ?>">
                </p>
            </li>
            <li><strong>Award Type :</strong>You can add/update award type for rewarding an employee.<br>
                <p>
                    <img alt="" src="<?php echo e(asset('docs/assets/images/award_type.png')); ?>">
                </p>
            </li>
            <li><strong>Warning Type :</strong>You can add/update warning type.<br>
                <p>
                    <img alt="" src="<?php echo e(asset('docs/assets/images/warning_type.png')); ?>">
                </p>
            </li>
            <li><strong>Termination Type :</strong>You can add/update termination type here.<br>
                <p>
                    <img alt="" src="<?php echo e(asset('docs/assets/images/termination_type.png')); ?>">
                </p>
            </li>
            <li><strong>Termination Type :</strong>You can add/update termination type here.<br>
                <p>
            ...
            <li><strong>Expense Type :</strong>You can add/update expense type here that will be needed for
                ...
                <p>
                    <img alt="" src="<?php echo e(asset('docs/assets/images/expense_type.png')); ?>">
                </p>
            </li>
            <li><strong>Emplyee Status :</strong>You can add/update employee status here<br>
                <p>
                    <img alt="" src="<?php echo e(asset('docs/assets/images/employee_status.png')); ?>">
                </p>
            </li>
            <li><strong>Document Type :</strong>Different types of document can be added/updated here . This is
                ...
                <p>
                    <img alt="" src="<?php echo e(asset('docs/assets/images/document_type.png')); ?>">
                </p>
            </li>
        </ul>
    </section>
    ...
    <section id="variable_method">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/variable_method.png')); ?>">
        </p>
        <ul>
            <li><strong>Arrangement Method :</strong>You can add/update new arrangement method. In order to add
                ...
                <p>
                    <img alt="" src="<?php echo e(asset('docs/assets/images/arrangement_method.png')); ?>">
                </p>
            </li>
            <li><strong>Payment Type :</strong>You can add/update payment method with their associated payment
                ...
                <p>
                    <img alt="" src="<?php echo e(asset('docs/assets/images/payment_type.png')); ?>">
                </p>
            </li>
            <li><strong>Qualification :</strong>You can add/update different types qualification of an employee,e.g.
                ...
                <p>
                    <img alt="" src="<?php echo e(asset('docs/assets/images/qualification.png')); ?>">
                </p>
            </li>
            <li><strong>Job Category :</strong>Different types of job category for job post record can added/updated
                here.<br>
                <p>
                    <img alt="" src="<?php echo e(asset('docs/assets/images/job_category.png')); ?>">
                </p>
            </li>
    ...
    <section id="ip_setting">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/what_is_my_ip.png')); ?>">
        </p>
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/ip_setting.png')); ?>">
        </p>
    </section>
    ...
    <section id="employee_list">
        ...
        <p>
            <!-- <img alt="" src="<?php echo e(asset('docs/assets/images/employee_list1.png')); ?>"> -->
            <img alt="" src="<?php echo e(asset('docs/assets/images/employee_list.png')); ?>">
        </p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/employee_add.png')); ?>">
        </p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/employee_filter.png')); ?>">
        </p>
        <p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/employee_details1.png')); ?>">
        </p>
        <p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/employee_basic1.png')); ?>">
        </p>
        <p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/employee_immigration1.png')); ?>">
        </p>
        <p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/employee_emergency1.png')); ?>">
        </p>
        <p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/employee_social1.png')); ?>">
        </p>
        <p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/employee_document1.png')); ?>">
        </p>
        <p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/employee_qualification1.png')); ?>">
        </p>
        <p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/employee_work1.png')); ?>">
        </p>
        <p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/employee_bank1.png')); ?>">
        </p>
        <p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/employee_profile1.png')); ?>">
        </p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/employee_salary1.png')); ?>">
        </p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/employee_allowance1.png')); ?>">
        </p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/employee_commision1.png')); ?>">
        </p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/employee_loan1.png')); ?>">
        </p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/employee_deduction1.png')); ?>">
        </p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/employee_other_payment1.png')); ?>">
        </p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/employee_overtime1.png')); ?>">
        </p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/employee_leave1.png')); ?>">
        </p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/employee_core_hr1.png')); ?>">
        </p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/employee_project.png')); ?>">
        </p>
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/employee_task.png')); ?>">
        </p>
        ...
        <p>
            Payslip
            <img alt="" src="<?php echo e(asset('docs/assets/images/employee_payslip1.png')); ?>">
        </p>

        <strong>View</strong>

        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/payslip_view.png')); ?>">
        </p>
    ...
    <section id="import_employee">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/import_employee.png')); ?>">
        </p>
        <ul>
        ...
        <p>
            ...
            patiently.<br>
            <img alt="" src="<?php echo e(asset('docs/assets/images/import_employee1.png')); ?>">
        </p>
    </section>
    ...
    <section id="user_list">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/user_list2.png')); ?>">
        </p>
    ...
    <section id="user_last_login">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/user_last_login.png')); ?>">
        </p>
    </section>
    ...
    <section id="promotion">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/promotion.png')); ?>">
        </p>
    </section>
    ...
    <section id="award">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/award.png')); ?>">
        </p>
    </section>
    ...
    <section id="travel">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/travel.png')); ?>">
        </p>
    </section>
    ...
    <section id="transfer">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/transfer.png')); ?>">
        </p>
    </section>
    ...
    <section id="resignation">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/resignation.png')); ?>">
        </p>
    </section>
    ...
    <section id="complaint">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/complaint.png')); ?>">
        </p>
    </section>
    ...
    <section id="warning">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/warning.png')); ?>">
        </p>
    </section>
    ...
    <section id="termination">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/termination.png')); ?>">
        </p>
    </section>
    ...
    <section id="announcement">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/announcement.png')); ?>">
        </p>
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/announcement1.png')); ?>">
        </p>
    </section>
    ...
    <section id="policy">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/policy.png')); ?>">
        </p>
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/policy1.png')); ?>">
        </p>
    </section>
    ...
    <section id="attendance">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/attendance.png')); ?>">
        </p>
        <p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/attendance_info.png')); ?>">
        </p>
    </section>
    ...
    <section id="datewise_attendance">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/datewise_attendance.png')); ?>">
        </p>
        <p>
            Datewise attendance table
        </p>
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/datewise_attendance_table.png')); ?>">
        </p>
    </section>
    ...
    <section id="monthly_attendance">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/monthly_attendance_table.png')); ?>">
        </p>
        <p>
            Admin can select month,company or employee to filter out for the desired result.
        </p>
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/monthly_attendance.png')); ?>">
        </p>
    </section>
    ...
    <section id="update_attendance">
        ...
        <p>
            Search or Get (1)
            <img alt="" src="<?php echo e(asset('docs/assets/images/update_attendance_get.png')); ?>">
        </p>
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/update_attendance_get_add.png')); ?>">
        </p>
        <p>
            Add (2)
            <img alt="" src="<?php echo e(asset('docs/assets/images/update_attendance_add.png')); ?>">
        </p>
        <p>
            Edit (3)
            <img alt="" src="<?php echo e(asset('docs/assets/images/update_attendance_edit.png')); ?>">
        </p>
    ...
    <section id="import_attendance">
        ...
        <p>
            ...
            <img alt="" src="<?php echo e(asset('docs/assets/images/import_attendance.png')); ?>">
        </p>
    </section>
    ...
    <section id="manage_holiday">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/holiday.png')); ?>">
        </p>
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/holiday_add.png')); ?>">
        </p>
    </section>
    ...
    <section id="manage_leave">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/leave.png')); ?>">
        </p>
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/leave_add.png')); ?>">
        </p>
    </section>
    ...
    <section id="payslip_report">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/payslip_report_table.png')); ?>">
        </p>
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/payslip_report.png')); ?>">
        </p>
    </section>
    ...
    <section id="training_report">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/training_report.png')); ?>">
        </p>
    </section>
    ...
    <section id="project_report">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/project_report_search.png')); ?>">
        </p>
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/project_report.png')); ?>">
        </p>
    </section>
    ...
    <section id="task_report">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/task_report_search.png')); ?>">
        </p>
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/task_report.png')); ?>">
        </p>
    </section>
    ...
    <section id="employee_report">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/employee_report.png')); ?>">
        </p>
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/employee_report_search.png')); ?>">
        </p>
    </section>
    ...
    <section id="account_report">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/account_report.png')); ?>">
        </p>
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/account_report_search.png')); ?>">
        </p>
    </section>
    ...
    <section id="expense_report">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/expense_report_search.png')); ?>">
        </p>
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/expense_report.png')); ?>">
        </p>
    </section>
    ...
    <section id="deposit_report">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/deposit_report_search.png')); ?>">
        </p>
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/deposit_report.png')); ?>">
        </p>
    </section>
    ...
    <section id="transaction_report">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/transaction_report_search.png')); ?>">
        </p>
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/transaction_report.png')); ?>">
        </p>
    </section>
    ...
    <section id="job_post">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/job_post.png')); ?>">
        </p>
        <p>
            (1)
            <img alt="" src="<?php echo e(asset('docs/assets/images/job_post_add.png')); ?>">
        </p>
        <p>
            (3)
            <img alt="" src="<?php echo e(asset('docs/assets/images/job_post_details1.png')); ?>">
            <img alt="" src="<?php echo e(asset('docs/assets/images/job_post_details2.png')); ?>">
        </p>
    </section>
    ...
    <section id="job_post">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/job_candidate.png')); ?>">
        </p>
        <strong>Details</strong>
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/job_candidate_details.png')); ?>">
        </p>
    ...
    <section id="job_interview">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/job_interview.png')); ?>">
        </p>
    ...
    <section id="cms">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/cms.png')); ?>">
        </p>
    ...
    <section id="training_type">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/training_type.png')); ?>">
        </p>
    ...
    <section id="trainer">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/trainer.png')); ?>">
        </p>
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/trainer_add.png')); ?>">
        </p>
    ...
    <section id="training_list">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/training_list.png')); ?>">
        </p>
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/training_list_add.png')); ?>">
        </p>
    ...
    <section id="new_payment">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/new_payment.png')); ?>">
        </p>
        <p>
            The search filter can be used to search to get payroll information of the selected employees.
        </p>
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/new_payment_search.png')); ?>">
        </p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/payroll_table.png')); ?>">
        </p>
        <p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/paid_payslip.png')); ?>">
        </p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/pay_payslip.png')); ?>">
        </p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/new_payment_bulk.png')); ?>">
        </p>
    ...
    <section id="payment_history">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/payment_history.png')); ?>">
        </p>
    </section>
    ...
    <section id="goal_type">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/goal_type_list.png')); ?>">
        </p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/add_goal_type.png')); ?>">
        </p>
    </section>
    ...
    <section id="goal_tracking">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/goal_tracking_list.png')); ?>">
        </p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/add_new_goal_tracking.png')); ?>">
        </p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/edit_goal_tracking.png')); ?>">
        </p>
    </section>
    ...
    <section id="indicator">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/indicator_list.png')); ?>">
        </p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/add_indicator.png')); ?>">
        </p>
    </section>
    ...
    <section id="appraisal">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/appraisal_list.png')); ?>">
        </p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/add_appraisal.png')); ?>">
        </p>
    </section>
    ...
    <section id="event">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/event.png')); ?>">
        </p>
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/event_add.png')); ?>">
        </p>
    ...
    <section id="meeting">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/meeting.png')); ?>">
        </p>
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/meeting_add.png')); ?>">
        </p>
    ...
    <section id="client">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/client.png')); ?>">
        </p>
        <strong>Add Client</strong>

        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/client_add.png')); ?>">
        </p>
    </section>
    ...
    <section id="tax_type">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/tax_type.png')); ?>">
        </p>
        <strong>Add tax Type</strong>
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/tax_type_add.png')); ?>">
        </p>
    </section>
    ...
    <section id="project">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/project.png')); ?>">
        </p>
        <strong>Add Project</strong>

        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/project_add.png')); ?>">
        </p>
        <strong>Project Details</strong>

        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/project_details1.png')); ?>">
        </p>
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/project_details2.png')); ?>">
        </p>
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/project_details3.png')); ?>">
        </p>
    ...
    <section id="task">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/task.png')); ?>">
        </p>
        <strong>Add Task</strong>

        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/task_add.png')); ?>">
        </p>
        <p>
            <strong>Task Details</strong>
            <img alt="" src="<?php echo e(asset('docs/assets/images/task_details.png')); ?>">
        </p>
    ...
    <section id="invoice">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/invoice.png')); ?>">
        </p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/invoice_add.png')); ?>">
        </p>
        <p>
            <strong>Details of Invoice</strong><br>
        </p>
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/invoice_details.png')); ?>">
        </p>
    ...
    <section id="support_ticket">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/support_ticket.png')); ?>">
        </p>
        <strong>Add Ticket</strong>
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/support_ticket_add.png')); ?>">
        </p>
        <p>
            <strong>Ticket Details</strong>
            <img alt="" src="<?php echo e(asset('docs/assets/images/support_ticket_details.png')); ?>">
        </p>
    ...
    <section id="account_balance">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/available_balance.png')); ?>">
        </p>
    ...
    <section id="payee">
        ...
        <p>
            ...
            paid.
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/payee.png')); ?>">
        </p>
    ...
    <section id="payer">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/payer.png')); ?>">
        </p>
    ...
    <section id="deposit">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/deposit.png')); ?>">
        </p>

        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/deposit_add.png')); ?>">
        </p>
    ...
    <section id="expense">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/expense.png')); ?>">
        </p>

        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/expense_add.png')); ?>">
        </p>
    ...
    <section id="transaction">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/transaction.png')); ?>">
        </p>
    ...
    <section id="transfer">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/finance_transfer.png')); ?>">
        </p>
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/add_transfer.png')); ?>">
        </p>
    ...
    <section id="asset_category">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/asset_category.png')); ?>">
        </p>
    ...
    <section id="asset">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/asset.png')); ?>">
        </p>
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/asset_add.png')); ?>">
        </p>
    ...
    <section id="file_configuration">
        ...
        <p>
            ...
            here.
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/file_configuration.png')); ?>">
        </p>
    ...
    <section id="file_manager">
        ...
        <p>
            ...
            etc.
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/file_manager.png')); ?>">
        </p>
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/file_manager_add.png')); ?>">
        </p>
    ...
    <section id="official_document">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/official_document.png')); ?>">
        </p>
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/official_document_add.png')); ?>">
        </p>
    ...
    <section id="client_dashboard">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/client_dashboard.png')); ?>">
        </p>
    ...
    <section id="client_project">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/client_project.png')); ?>">
        </p>

        <strong>Add Project</strong>
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/client_project_add.png')); ?>">
        </p>
    ...
    <section id="client_task">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/client_task.png')); ?>">
        </p>

        <strong>Add Task</strong>
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/client_task_add.png')); ?>">
        </p>
    ...
    <section id="client_invoice">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/client_invoice.png')); ?>">
        </p>

        <strong>Details</strong>
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/client_invoice_details.png')); ?>">
        </p>
    </section>
    ...
    <section id="client_invoice_paid">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/client_invoice_paid.png')); ?>">
        </p>

        <strong>Details</strong>
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/client_invoice_paid_details.png')); ?>">
        </p>
    </section>
    ...
    <section id="employee_dashboard">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/employee_dashboard.png')); ?>">
        </p>

        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/employee_dashboard1.png')); ?>">
        </p>
        <ol>
            <li><strong>Profile:</strong> Employee can go the profile page and update profile info if needed</li>
            <p>
            <p>
                <img alt="" src="<?php echo e(asset('docs/assets/images/employee_profile_self.png')); ?>">
            </p>
            </p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/employee_dashboard2.png')); ?>">
        </p>
        <p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/employee_dashboard3.png')); ?>">
        </p>
        <p>
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/employee_dashboard4.png')); ?>">
        </p>
        <p>
    ...
    <section id="general_error">
        ...
        <p>
            <img alt="" src="<?php echo e(asset('docs/assets/images/general_error.png')); ?>">
        </p>
    </section>
    ...
    <section id="autoUpdateFeature">
        ...
        <p><img src="<?php echo e(asset('docs/assets/images/auto_update/1.Notification-Version-Upgrade.png')); ?>"></p>
        ...
        <p><img src="<?php echo e(asset('docs/assets/images/auto_update/3.Version-Upgrade-Page.png')); ?>"></p>

        <p>After upgrading, it'll redirect to you here.</p>
        <p><img src="<?php echo e(asset('docs/assets/images/auto_update/4.success-version-upgrade.png')); ?>"></p>

        <h5><b>Error -</b></h5>
        <p>If you see this notification during upgrade, please contact at <a href="lion-coders.com/support">Support Panel</a>.</p>
        <p><img src="<?php echo e(asset('docs/assets/images/auto_update/8.Error.png')); ?>"></p>
        ...
        <p><img src="<?php echo e(asset('docs/assets/images/auto_update/2.Notification-Bug-Update.png')); ?>"></p>

        <h5><b>Procedure -</b></h5>

        <p>After clicking, it'll redirect to this page you will see the change log details & update button. Click the Update button.</p>
        <p><img src="<?php echo e(asset('docs/assets/images/auto_update/5.Bug-Update-page.png')); ?>"></p>

        <p>After updating, it'll redirect to you here.</p>
        <p><img src="<?php echo e(asset('docs/assets/images/auto_update/6.success-bug-update.png')); ?>"></p>


        <h5><b>Error -</b></h5>
        <p>If you see this notification during update, please contact at <a href="lion-coders.com/support">Support Panel</a>.</p>
        <p><img src="<?php echo e(asset('docs/assets/images/auto_update/7.Error.png')); ?>"></p>
    </section>
...
<?php /**PATH /var/www/html/peoplepro/peoplepro-hrm-crm/resources/views/documentation/index.blade.php ENDPATH**/ ?>