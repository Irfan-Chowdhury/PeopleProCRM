                    ...
                    <div class="card">
                        ...
                        <div class="container">
                            <?php if($user->profile_photo): ?>
                                <td> <img src="<?php echo e(url('uploads/profile_photos', $user->profile_photo)); ?>" height="120"
                                        width="120">
                                </td>
                            <?php else: ?>
                                <td> <img src="<?php echo e(url('logo/avatar.jpg')); ?>" height="120" width="120">
                                </td>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="card-body">
                            <p class="italic">
                                <small><?php echo e(__('The field labels marked with * are required input fields')); ?>.</small></p>
                            <form method="POST" action="<?php echo e(route('profile_update', $user->id)); ?>"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input readonly type="text" name="username" value="<?php echo e($user->username); ?>"
                                                required class="form-control" />
...
<?php echo $__env->make('layout.client', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/peoplepro/peoplepro-hrm-crm/resources/views/profile/client_profile.blade.php ENDPATH**/ ?>