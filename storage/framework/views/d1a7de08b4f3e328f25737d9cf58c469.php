...
<section class="container">
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <?php if(env('PRODUCT_MODE')!=='DEMO'): ?>
                        <a href="<?php echo e(route('biometric-install-step-1')); ?>" class="btn btn-primary p-2">Go to Install</a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="card">
                <img class="card-img-top" src="<?php echo e(asset('logo/peopleprosaas.png')); ?>" style="height:250px" alt="Card image cap">
                <div class="card-body">
                    ...
                    <?php if(env('PRODUCT_MODE')!=='DEMO'): ?>
                        <a href="<?php echo e(route('saas-install-step-1')); ?>" class="btn btn-primary p-2">Go to Install</a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="card">
                <img class="card-img-top" src="<?php echo e(asset('logo/crm.jpg')); ?>" style="height:250px" alt="Card image cap">
                <div class="card-body">
                    ...
                    <a href="https://peopleprohrmsaas.com/central-documentation" class="btn btn-warning p-2" target="_blank">Documentation</a>
                    <?php if(env('PRODUCT_MODE')!=='DEMO'): ?>
                        <a href="<?php echo e(route('crm-install-step-1')); ?>" class="btn btn-primary p-2">Go to Install</a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/peoplepro/peoplepro-hrm-crm/resources/views/addons/index.blade.php ENDPATH**/ ?>