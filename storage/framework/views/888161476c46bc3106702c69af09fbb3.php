    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editModalLabel"> <?php echo e(__('file.Edit Contact')); ?></h5>
            ...
            <div class="modal-body">
                ...
                <form method="POST" action="<?php echo e(route('lead.contact.update', ['lead' => $lead->id, 'leadContact'=>1])); ?>" id="updateForm" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="row">
...
<?php /**PATH /var/www/html/peoplepro/peoplepro-hrm-crm/Modules/CRM/resources/views/lead_section/contact/edit-modal.blade.php ENDPATH**/ ?>