...
<body>
    <div class="col-md-6 offset-md-3">
        <div class='wrapper'>
            ...
            <p>
                    ...
                    Please  <strong><a href="<?php echo e(url('/')); ?>" target="__blank">Click Here</a></strong> to visit the app.
                </p>
            </div>
            <hr>
    ...
    <script type="text/javascript" src="<?php echo e(asset('install-assets/js/jquery.min.js')); ?>"></script>
</body>
</html>
<?php /**PATH /var/www/html/peoplepro/peoplepro-hrm-crm/resources/views/addons/crm/step_4.blade.php ENDPATH**/ ?>