                ...
                <div class="row">
                    <div class="col-xs-12 table-responsive">
                        <table class="table ">
                            ...
                            <tbody>
                            <?php $__currentLoopData = $invoice_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$invoice_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td class="py-3">
                                        <div class="font-weight-semibold"><?php echo e($invoice_item->item_name); ?></div>
                                    </td>
                                    <td class="py-3"><strong><?php echo e($invoice_item->item_qty); ?></strong></td>
                                    <td class="py-3"><strong><?php echo e($invoice_item->item_unit_price); ?></strong></td>
                                    <td class="py-3"><strong><?php echo e($invoice_item->item_tax_rate); ?></strong></td>
                                    <td class="py-3"><strong><?php echo e($invoice_item->item_sub_total); ?></strong></td>
...
<?php echo $__env->make('layout.client', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/peoplepro/peoplepro-hrm-crm/resources/views/client/invoice_show.blade.php ENDPATH**/ ?>