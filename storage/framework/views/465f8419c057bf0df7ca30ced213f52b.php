...
<div id="documenter_sidebar">
    <img src="<?php echo e(asset('docs/attendance_device_addon/assets/images/logo.png')); ?>" style="border: none;margin: 0 10px -10px;width: 40px">
...
<div id="documenter_content">
    ...
    <section id="how_to_use">
        ...
        <p>
            ...
            <img alt="" src="<?php echo e(asset('docs/attendance_device_addon/assets/images/1.png')); ?>">
        </p>
        <p>
            2. Set IP in the attendance device.
            <img alt="" src="<?php echo e(asset('docs/attendance_device_addon/assets/images/2.png')); ?>">
        </p>
        <p>
            3. Connect the device to device provider software. For example: connect ZKTeco to ZKTeco attendance software.
            <img alt="" src="<?php echo e(asset('docs/attendance_device_addon/assets/images/3.png')); ?>">
        </p>
        <p>
            4. Import employee list to device provider software.
            <img alt="" src="<?php echo e(asset('docs/attendance_device_addon/assets/images/4.png')); ?>">
        </p>
        <p>
            5. Add employee to device.
            <img alt="" src="<?php echo e(asset('docs/attendance_device_addon/assets/images/5.png')); ?>">
        </p>
        <p>
            6. Take attendance via device.
            <img alt="" src="<?php echo e(asset('docs/attendance_device_addon/assets/images/6.png')); ?>">
        </p>
        <p>
            7. Export attendance log from device provider software.
            <img alt="" src="<?php echo e(asset('docs/attendance_device_addon/assets/images/7.png')); ?>">
        </p>
        <p>
            8. Set attendance device date format in our software peoplepro.
            <img alt="" src="<?php echo e(asset('docs/attendance_device_addon/assets/images/8.png')); ?>">
        </p>
        <p>
            9. Import attendance log in our software peoplepro.
            <img alt="" src="<?php echo e(asset('docs/attendance_device_addon/assets/images/9.png')); ?>">
        </p>
    </section>
...
<?php /**PATH /var/www/html/peoplepro/peoplepro-hrm-crm/resources/views/documentation/attendance_device_addon/index.blade.php ENDPATH**/ ?>