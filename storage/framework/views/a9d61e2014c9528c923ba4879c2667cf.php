        ...
        <div class='wrapper'>
            ...
            <div class="content">
                ...
                <?php if ($passed == '1111'): ?>
                    ...
                    <a href="<?php echo e(route('crm-install-step-3')); ?>" class="btn btn-primary">Continue</a>
...
<?php /**PATH /var/www/html/peoplepro/peoplepro-hrm-crm/resources/views/addons/crm/step_2.blade.php ENDPATH**/ ?>