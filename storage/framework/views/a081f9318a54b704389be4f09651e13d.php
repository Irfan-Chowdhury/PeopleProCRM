        ...
        <div class="modal-content">
            ...
            <form method="POST" id="submitForm" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="row">
                        <input type="hidden" name="estimate_id" value="<?php echo e($estimate->id); ?>" class="form-control">
...
<?php /**PATH /var/www/html/peoplepro/peoplepro-hrm-crm/Modules/CRM/resources/views/prospects/estimate/estimate_item/create-modal.blade.php ENDPATH**/ ?>