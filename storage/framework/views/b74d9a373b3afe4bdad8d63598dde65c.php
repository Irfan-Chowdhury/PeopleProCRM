    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editModalLabel"> <?php echo e(__('file.Edit Task')); ?></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form method="POST" action="<?php echo e(route('lead.task.update', ['lead' => $lead->id, 'leadTask'=> 7])); ?>" id="updateForm" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="points" id="pointsEdit" class="form-control selectpicker" data-live-search="true" data-live-search-style="contains" title="<?php echo e(__('Selecting',['key'=>trans('file.Status')])); ?>...">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="priority" id="priorityEdit" class="form-control" title="<?php echo e(__('Selecting',['key'=>trans('file.Priority')])); ?>...">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="labels" id="labelsEdit" class="form-control selectpicker" title="<?php echo e(__('Selecting',['key'=>trans('file.Labels')])); ?>...">
...
<?php /**PATH /var/www/html/peoplepro/peoplepro-hrm-crm/Modules/CRM/resources/views/lead_section/task/edit-modal.blade.php ENDPATH**/ ?>