...
<div class="container">
    <div class="card">
        ...
        <form action="<?php echo e(route('client.store.processOrder')); ?>" method="post">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.client', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/peoplepro/peopleprocrm/Modules/CRM/resources/views/client/store/chekout.blade.php ENDPATH**/ ?>