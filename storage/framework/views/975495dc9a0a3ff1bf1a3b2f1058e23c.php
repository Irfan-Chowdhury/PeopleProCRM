        ...
        <table id="dataListTable" class="table ">
            <thead>
                <tr>
                    ...
                    <th><?php echo e(trans('file.Proposal')); ?></th>
                    <th><?php echo e(trans('file.Proposal Date')); ?></th>
...
<?php echo $__env->make('crm::lead_section.proposals.create-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('crm::lead_section.proposals.edit-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script type="text/javascript">
    let dataTableURL = "<?php echo e(route('lead.proposals.datatable', ['lead' => $lead->id])); ?>";
    let storeURL = "<?php echo e(route('lead.proposals.store', ['lead' => $lead->id])); ?>";
    var editURL = "<?php echo e(url('/leads/details')); ?>/" + "<?php echo e($lead->id); ?>/proposals/edit/" ;
    var updateURL = "<?php echo e(url('/leads/details')); ?>/" + "<?php echo e($lead->id); ?>/proposals/update/" ;
    let destroyURL = "<?php echo e(url('/leads/details')); ?>/" + "<?php echo e($lead->id); ?>/proposals/destroy/";
    let bulkDeleteURL = '<?php echo e(route('lead.proposals.bulk_delete', ['lead' => $lead->id])); ?>';
</script>
...
<?php echo $__env->make('crm::lead_section.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/peoplepro/peoplepro-hrm-crm/Modules/CRM/resources/views/lead_section/proposals/index.blade.php ENDPATH**/ ?>