                ...
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs d-flex justify-content-between" id="myTab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="remainingLeaveType-tab" data-toggle="tab" href="#remainingLeaveType"
                               ...
                               aria-selected="false"><?php echo e(trans('file.Remaining Leave')); ?>
                    ...
                    <div class="tab-content" id="myTabContent">
                                        ...
                                        <div class="tab-pane fade show active" id="Basic" role="tabpanel"
                                            ...
                                            <form method="post" id="basic_sample_form" class="form-horizontal"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        <label><?php echo e(__('Staff Id')); ?> <span class="text-danger">*</span></label>
                                                        <input type="text" name="staff_id" id="staff_id"
                                                               placeholder="<?php echo e(__('Staff Id')); ?>"
                                                               required class="form-control"
                                                               value="<?php echo e($employee->staff_id); ?>">
                                                    </div>
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        <label><?php echo e(trans('file.Office_Shift')); ?> <span class="text-danger">*</span></label>
                        ...
                        <div class="tab-pane fade" id="remainingLeaveType" role="tabpanel"
                            ...
                            <?php echo e(trans('file.Remaining Leave')); ?>

                            <hr>
                            <?php echo $__env->make('employee.remaining_leave.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
...
<script type="text/javascript">
   ...
   $('#other_payment-tab').one('click', function (e) {
    ...
    $('#remainingLeaveType-tab').one('click', function (e) {
        <?php echo $__env->make('employee.remaining_leave.index_js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    });
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/peoplepro/peopleprocrm/resources/views/employee/dashboard.blade.php ENDPATH**/ ?>