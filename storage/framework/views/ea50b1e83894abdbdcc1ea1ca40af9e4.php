        ...
        $(document).on('click', '.edit', function() {
            ...
            $.get({
                ...
                success: function (response) {
                    ...
                    $("#modelId").val(response.leadNote.id);
                    $("#editModal input[name='title']").val(response.leadNote.title);
                    $("#noteEdit").val(response.leadNote.note);
...
<?php echo $__env->make('crm::lead_section.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/peoplepro/peoplepro-hrm-crm/Modules/CRM/resources/views/lead_section/notes/index.blade.php ENDPATH**/ ?>