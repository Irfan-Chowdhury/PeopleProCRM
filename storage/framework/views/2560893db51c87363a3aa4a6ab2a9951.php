...
<div class="modal fade bd-example-modal-lg" id="createModal" tabindex="-1" role="dialog" aria-labelledby="createModalLabel"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form method="POST" action="<?php echo e(route('lead.proposals.store', ['lead' => $lead->id])); ?>" id="submitForm">
                <?php echo csrf_field(); ?>
...
<?php /**PATH /var/www/html/peoplepro/peoplepro-hrm-crm/Modules/CRM/resources/views/lead_section/proposals/create-modal.blade.php ENDPATH**/ ?>