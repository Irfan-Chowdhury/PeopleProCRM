...
@include('crm::lead_section.contracts.create-modal')
@include('crm::lead_section.contracts.edit-modal')
...
<script type="text/javascript">
    let dataTableURL = "{{ route('lead.contracts.datatable', ['lead' => $lead->id]) }}";
    let storeURL = "{{ route('lead.contracts.store', ['lead' => $lead->id]) }}";
    var editURL = "{{ url('/leads/details')}}/" + "{{ $lead->id }}/contracts/edit/" ;
    var updateURL = "{{ url('/leads/details')}}/" + "{{ $lead->id }}/contracts/update/" ;
    let destroyURL = "{{ url('/leads/details')}}/" + "{{ $lead->id }}/contracts/destroy/";
    let bulkDeleteURL = '{{ route('lead.contracts.bulk_delete', ['lead' => $lead->id]) }}';
</script>
