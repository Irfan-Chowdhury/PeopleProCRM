    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createModalLabel"> {{ __('file.Add Contact') }}</h5>
            ...
            <div class="modal-body">
                ...
                <form method="POST" action="{{ route('lead.contact.store', ['lead' => $lead->id]) }}" id="submitForm" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
