...
<div class="container-fluid">
    <div class="card">
        <div class="card-header"><h3>{{__('file.Estimate Request Form')}}</h3></div>
...
@include('crm::prospects.estimate_form.create-modal')
@include('crm::prospects.estimate_form.edit-modal')
...
<script type="text/javascript">
    let dataTableURL = "{{ route('prospects.estimate-forms.datatable') }}";
    let storeURL = "{{ route('prospects.estimate-forms.store') }}";
    ...
    let bulkDeleteURL = '{{route('prospects.estimate-forms.bulk_delete')}}';
</script>
